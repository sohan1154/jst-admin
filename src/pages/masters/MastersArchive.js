...
class MastersArchive extends React.Component {
    ...
    getArchiveUsers = (role) => {
        ...
        ApisService.getMasterArchiveUsers(role)
            .then(response => {
    ...
    restoreAccount = (id, index) => {
        ...
        GlobalProvider.confirmBox("Are you Sure? You want to restore this account.", (isTrue) => {
            if (isTrue) {
                ApisService.restoreMasterAccount(id)
                    .then(response => {
                            ...
                            <div className="container  m-b-30">
                                <div className="row">
                                    <div className="col-12 text-white p-t-40 p-b-90">
                                        <h4 className="">Archived Masters</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
