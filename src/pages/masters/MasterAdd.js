...
class MasterAdd extends React.Component {
    ...
    create = (e) => {
        ...
        if (!errors) {
            ...
            ApisService.createMasterAccount(formData)
                .then(response => {
                                                ...
                                                <form className="needs-validation" onSubmit={this.create}>
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-group col-md-6">
                                                            ...
                                                            <input type="number" step="any" className="form-control" name="margin_per" onKeyUp={this.handleChange} />
                                                            {errors.margin_per && <span className="error">{errors.margin_per}</span>}
                                                        </div>
                                                        <div className="form-group col-md-6">
                                                            <label for="inputPassword4">Margin in fix</label>
                                                            <input type="number" step="any" className="form-control" name="margin_fix" onKeyUp={this.handleChange} />
